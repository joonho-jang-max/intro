...
function BenefitBanner() {
  ...
  return (
    <div style={{ background: LIGHT_BG, paddingTop: 8 }}>
      <div
        ref={ref}
        style={{
          display: 'flex',
...
function BottomNav() {
  return (
    <div style={{ position: 'fixed', bottom: 0, left: 0, right: 0, background: WHITE, borderTop: '1px solid #e5e5e5', display: 'flex', height: 50, alignItems: 'center', zIndex: 10 }}>
...
export default function Component() {
  ...
  return (
    <div style={{ background: LIGHT_BG, minHeight: '100vh', paddingBottom: 50, fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' }}>
      <GNB />
